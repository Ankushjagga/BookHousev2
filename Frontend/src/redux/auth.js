...
Cookies.get("loginData") !== "undefined" && Cookies.get("loginData")
  ...
  //REGISTER USER
      export const registerUser = createAsyncThunk(
        ...
        async (obj, thunkAPI) => {
          try {
            const response = await fetch(`${import.meta.env.VITE_API}/v2/auth/register`, {
              method: "POST",
              headers: {
      ...
      export const loginUser = createAsyncThunk(
        ...
        console.log(obj)
          try {
            const response = await fetch(`${import.meta.env.VITE_API}/v2/auth/login`, {
              method: "POST",
              headers: {
                Accept: "application/json",
                "Content-Type": "application/json",
   ...
   export const contactUs = createAsyncThunk(
    ...
    console.log(obj)
      try {
        const response = await fetch(`${import.meta.env.VITE_API}/v2/auth/contactUs`, {
          method: "POST",
          headers: {
            Accept: "application/json",
            "Content-Type": "application/json",
  ...
  export const forgetPassword = createAsyncThunk(
    ...
    console.log(obj)
      try {
        const response = await fetch(`${import.meta.env.VITE_API}/v2/auth/forgetPassword`, {
          method: "POST",
          headers: {
            Accept: "application/json",
            "Content-Type": "application/json",
  ...
  export const resetPassword = createAsyncThunk(
    ...
    console.log(obj, "obkkadkkasd")
      try {
        const response = await fetch(`${import.meta.env.VITE_API}/v2/auth/resetPassword/${obj.token}`, {
          method: "POST",
          headers: {
            Accept: "application/json",
            "Content-Type": "application/json",
  ...
  export const getUserDetail = createAsyncThunk(
    ...
    async (obj, thunkAPI) => {
      try {
        ...
        const response = await fetch(`${import.meta.env.VITE_API}/v2/auth/getUserDetail/userId/${userId}`, {
          method: "GET",
          headers: {
            Accept: "application/json",
            "Content-Type": "application/json",
